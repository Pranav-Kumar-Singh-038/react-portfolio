...
`)}},MainFileMissingError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CORE-SERVER";this.code=6;this.stack="";this.documentation="https://storybook.js.org/docs/configure";}template(){return dedent`
    ...
    `}},MainFileEvaluationError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CORE-SERVER";this.code=7;this.stack="";}template(){let errorText=(0, import_chalk.white)((this.data.error.stack||this.data.error.message).replaceAll(process.cwd(),""));return dedent`
      Storybook couldn't evaluate your ${(0, import_chalk.yellow)(this.data.location)} file.

      ${errorText}
    `}},GenerateNewProjectOnInitError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CLI_INIT";this.code=3;}template(){return dedent`
      There was an error while using ${this.data.packageManager} to create a new ${this.data.projectType} project.
      
      ${this.data.error instanceof Error?this.data.error.message:""}
      `}},UpgradeStorybookToLowerVersionError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CLI_UPGRADE";this.code=3;}template(){return dedent`
    ...
    `}},UpgradeStorybookToSameVersionError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CLI_UPGRADE";this.code=4;}template(){return dedent`
    ...
    `}},UpgradeStorybookUnknownCurrentVersionError=class extends StorybookError{constructor(){super(...arguments);this.category="CLI_UPGRADE";this.code=5;}template(){return dedent`
    ...
    `}},UpgradeStorybookInWrongWorkingDirectory=class extends StorybookError{constructor(){super(...arguments);this.category="CLI_UPGRADE";this.code=6;}template(){return dedent`
    ...
    `}},NoStatsForViteDevError=class extends StorybookError{constructor(){super(...arguments);this.category="BUILDER-VITE";this.code=1;}template(){return dedent`
...
export { AngularLegacyBuildOptionsError, Category, ConflictingStaticDirConfigError, CouldNotEvaluateFrameworkError, CriticalPresetLoadError, GenerateNewProjectOnInitError, GoogleFontsDownloadError, GoogleFontsLoadingError, InvalidFrameworkNameError, InvalidStoriesEntryError, MainFileESMOnlyImportError, MainFileEvaluationError, MainFileMissingError, MissingAngularJsonError, MissingBuilderError, MissingFrameworkFieldError, NoMatchingExportError, NoStatsForViteDevError, NxProjectDetectedError, UpgradeStorybookInWrongWorkingDirectory, UpgradeStorybookToLowerVersionError, UpgradeStorybookToSameVersionError, UpgradeStorybookUnknownCurrentVersionError, WebpackCompilationError, WebpackInvocationError, WebpackMissingStatsError };
