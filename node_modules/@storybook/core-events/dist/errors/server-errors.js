...
`)}},MainFileMissingError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CORE-SERVER";this.code=6;this.stack="";this.documentation="https://storybook.js.org/docs/configure"}template(){return import_ts_dedent.default`
    ...
    `}},MainFileEvaluationError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CORE-SERVER";this.code=7;this.stack=""}template(){let errorText=(0,import_chalk.white)((this.data.error.stack||this.data.error.message).replaceAll(process.cwd(),""));return import_ts_dedent.default`
      Storybook couldn't evaluate your ${(0,import_chalk.yellow)(this.data.location)} file.

      ${errorText}
    `}},GenerateNewProjectOnInitError=class extends StorybookError{constructor(data){super();this.data=data;this.category="CLI_INIT";this.code=3}template(){return import_ts_dedent.default`
    ...
    `}};0&&(module.exports={AngularLegacyBuildOptionsError,Category,ConflictingStaticDirConfigError,CouldNotEvaluateFrameworkError,CriticalPresetLoadError,GenerateNewProjectOnInitError,GoogleFontsDownloadError,GoogleFontsLoadingError,InvalidFrameworkNameError,InvalidStoriesEntryError,MainFileESMOnlyImportError,MainFileEvaluationError,MainFileMissingError,MissingAngularJsonError,MissingBuilderError,MissingFrameworkFieldError,NoMatchingExportError,NoStatsForViteDevError,NxProjectDetectedError,UpgradeStorybookInWrongWorkingDirectory,UpgradeStorybookToLowerVersionError,UpgradeStorybookToSameVersionError,UpgradeStorybookUnknownCurrentVersionError,WebpackCompilationError,WebpackInvocationError,WebpackMissingStatsError});
